...
float PinControl::last_control(){
  return remap2(this->pwm_, 0l, 255l, v1, v2, false);  // Mappa l'ultimo valore PWM all'intervallo v1-v2
}
#endif
...
float PinMeasure::last_measure(){
  return remap2((long) this->value_, 0l, 1023l, v1, v2, false);  // Mappa l'ultimo valore analogico nell'intervallo v1-v2
}
#endif
